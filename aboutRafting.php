...
$(function(){
	$(document).on("click", '#jointable tr:last-child td:first-child', function () {
		$('#jointable').append($(this).parent().clone()); //this line must before changing photo
		$(this).children('img').attr('src','images/cancel.png').on('click', function(event){
			...
			<thead>
				...
				<tr>
					<td colspan="2"><p>
							...
							2.姓名、生日、身份證字號、聯絡電話(保險用資料) <br /> 3.請在報名表上方留1~2支行動電話以備出外聯絡 <br />
							4.泛舟報名請先匯款訂金泛舟費用之二分之ㄧ(每人)，尾款請於泛舟當日繳清。 <br />
						</p></td>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					<th width="100">便 當</th>
					<td>葷<input type="text" name="meal_m" style="width: 40px;" value="" />素<input
						type="text" name="meal_v" style="width: 40px;" value="" /> (填寫數量)
					</td>
				</tr>
				<tr>
					<th width="100">船 班</th>
				...
				<tr>
					...
					<td><input type="text" name="project" value="" /> (必填)
						請自行填入專案名稱或行程需求 【若超過兩天以上請<a href="order-car.php" target="_blank">填寫詳細行程表</a>】</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="lastfive" value="" /> (必填，如匯款請填入匯款人姓名)
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2">
						...
						※泛舟屬挑戰激烈之活動，台灣以照規定辦理國賠250萬，如泛舟中途受傷，皆由國家來理賠，法律訴訟等皆可再上訴。</br>
					</br> <font style="color: red;"><b>備註：以上泛舟事項不代表本台立場，純粹娛樂，請放鬆心情，閱讀注意事項，同意後再行填寫泛舟報名。</b>
					
					</td>
				</tr>
				<tr>
					<td align="center" colspan="2"><input type="reset" name="nosure"
						value="修改重填" style="width: 100px; height: 40px;">&nbsp;&nbsp;&nbsp;
						<input type="submit" name="sure" value="確定送出"
